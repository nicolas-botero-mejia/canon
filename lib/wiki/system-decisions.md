...
| ADR-020 | Skill and agent evals: promptfoo scenarios via npx, not push-CI | package-internal | Accepted | `ADR-020` invariants (configs + `skill-used` baseline + never-push-CI boundary); harness in `test/evals` |
