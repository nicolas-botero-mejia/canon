...
| ADR-019 | Markdown validation moves to a Node core; bash stays dispatch | package-internal | Accepted | stage 1 live: `md-rules` core + `content-index-fenced-example` regression; stages 2–3 tracked in #17 |
