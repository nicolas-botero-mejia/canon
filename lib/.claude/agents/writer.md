...
1. **Consult template-index.md** — `templates/template-index.md (framework — in node_modules)` is authoritative. Before creating any file, confirm: which template applies, which folder it goes to, what suffix it uses.
